<template>
  <div class="space-y-6">
    ...
    <div v-else class="space-y-6">
      ...
      <!-- 🖨️ Printable Invoice/Receipt Modal & Print Container -->
      <div v-if="showPrintModal" class="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto no-print-backdrop">
